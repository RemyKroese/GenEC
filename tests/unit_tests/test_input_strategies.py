...
@pytest.mark.unit
def test_regex_input_strategy_invalid_pattern(mock_config):
    ...
    strategy = RegexInputStrategy(mock_ask_question)
...
@pytest.mark.unit
def test_positional_input_strategy_invalid_line_number(mock_config):
    ...
    strategy = PositionalInputStrategy(mock_ask_question)
...
@pytest.mark.unit
def test_positional_input_strategy_zero_values(mock_config):
